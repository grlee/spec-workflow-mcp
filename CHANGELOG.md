...
- **VSCode Task Status Update** (PR #139) - Fixed task status updates failing in VSCode extension:
  - Removed race condition from redundant `sendTasks()` call competing with file watcher
